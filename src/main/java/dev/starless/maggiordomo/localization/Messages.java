...
public enum Messages {
    ...
    COMMAND_MANAGEMENT_ROOMS_DEFAULT_NICKNAME("commands.management.sections.rooms_manager.default_nickname"),
    COMMAND_MANAGEMENT_ROOMS_DEFAULT_USERNAME("commands.management.sections.rooms_manager.default_username"),
